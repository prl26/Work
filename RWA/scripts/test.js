...
async function fixture() {
    ...
    const v1 = await ethers.deployContract('Logic');
    const v2 = await ethers.deployContract('LogicV2');

    const proxy = await ethers
        .deployContract('RWAProxy', [v1, admin, '0x'])
        .then(instance => ethers.getContractAt('RWAProxy', instance));
...
describe('RWAProxyAdmin', function () {
