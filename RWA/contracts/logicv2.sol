...
contract LogicV2 is Initializable, ERC20Upgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    */
    ...
    function getIsMintInterest(address addr) external view returns (bool) {
        return isDisInterest[addr];
    }
    /**
    * ------------ 修改函數 ---------
    */
    ...
    function mintInterest(address to) external {
        ...
        uint256 mintAmount = (balance * initialInterestRate) / 100;
        // Assuming interest rate is a percentage
        _mint(to, mintAmount);
    }
}
